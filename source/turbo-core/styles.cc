...
const Language languages[] = {
    // NOTE: These need to be in the same order as the enum in the header.

    /* Language::Ada        */ {"Ada",         "--"},
    /* Language::Asm        */ {"Asm",         ";"},
    /* Language::Bash       */ {"Bash",        "#"},
    /* Language::Basic      */ {"Basic",       "'"},
    /* Language::Batch      */ {"Batch",       "rem "},
    /* Language::CPP        */ {"CPP",         "//", "/*", "*/"},
    /* Language::CSS        */ {"CSS",         {}, "/*", "*/"},
...
static const const_unordered_map<std::string_view, const Language *> mime2lang = {
    {"text/x-c++",                  &languages[Language::CPP]},
    {"text/x-c",                    &languages[Language::CPP]},
    {"text/x-script.python",        &languages[Language::Python]},
    {"application/json",            &languages[Language::JSON]},
    {"text/x-shellscript",          &languages[Language::Bash]},
    {"text/x-makefile",             &languages[Language::Makefile]},
    {"text/x-diff",                 &languages[Language::Diff]},
    {"text/html",                   &languages[Language::HTML]},
};

static const const_unordered_map<std::string_view, const Language *> ext2lang = {
    {".js",                         &languages[Language::JavaScript]},
    {".jsx",                        &languages[Language::JavaScript]},
    {".mjs",                        &languages[Language::JavaScript]},
    {".asm",                        &languages[Language::Asm]},
    {".s",                          &languages[Language::Asm]},
    {".S",                          &languages[Language::Asm]},
    {".c",                          &languages[Language::CPP]},
    {".cc",                         &languages[Language::CPP]},
    {".cpp",                        &languages[Language::CPP]},
    {".cxx",                        &languages[Language::CPP]},
    {".h",                          &languages[Language::CPP]},
    {".hh",                         &languages[Language::CPP]},
    {".hpp",                        &languages[Language::CPP]},
    {".hxx",                        &languages[Language::CPP]},
    {".py",                         &languages[Language::Python]},
    {".htm",                        &languages[Language::HTML]},
    {".html",                       &languages[Language::HTML]},
    {".mhtml",                      &languages[Language::HTML]},
    {".xml",                        &languages[Language::XML]},
    {".vb",                         &languages[Language::VB]},
    {".pl",                         &languages[Language::Perl]},
    {".pm",                         &languages[Language::Perl]},
    {".bat",                        &languages[Language::Batch]},
    {".tex",                        &languages[Language::LaTex]},
    {".lua",                        &languages[Language::Lua]},
    {".diff",                       &languages[Language::Diff]},
    {".ads",                        &languages[Language::Ada]},
    {".adb",                        &languages[Language::Ada]},
    {".lsp",                        &languages[Language::Lisp]},
    {".rb",                         &languages[Language::Ruby]},
    {".tcl",                        &languages[Language::Tcl]},
    {".vbs",                        &languages[Language::VBScript]},
    {".m",                          &languages[Language::MATLAB]},
    {".css",                        &languages[Language::CSS]},
    {".erl",                        &languages[Language::Erlang]},
    {".hrl",                        &languages[Language::Erlang]},
    {".st",                         &languages[Language::Smalltalk]},
    {".md",                         &languages[Language::Markdown]},
    {".rs",                         &languages[Language::Rust]},
    {".java",                       &languages[Language::CPP]},
    {"Makefile",                    &languages[Language::Makefile]},
    {"PKGBUILD",                    &languages[Language::Bash]},
    {".json",                       &languages[Language::JSON]},
    {"eslintrc",                    &languages[Language::JSON]},
    {".jshintrc",                   &languages[Language::JSON]},
    {".jsonld",                     &languages[Language::JSON]},
    {".ipynb",                      &languages[Language::JSON]},
    {".babelrc",                    &languages[Language::JSON]},
    {".prettierrc",                 &languages[Language::JSON]},
    {".stylelintrc",                &languages[Language::JSON]},
    {".jsonc",                      &languages[Language::JSON]},
    {".jscop",                      &languages[Language::JSON]},
    {".yml",                        &languages[Language::YAML]},
    {".yaml",                       &languages[Language::YAML]},
    {".clang-format",               &languages[Language::YAML]},
    {".clang-tidy",                 &languages[Language::YAML]},
    {".mir",                        &languages[Language::YAML]},
    {".apinotes",                   &languages[Language::YAML]},
    {".ifs",                        &languages[Language::YAML]},
    {".sh",                         &languages[Language::Bash]},
    {".bashrc",                     &languages[Language::Bash]},
    {".zshrc",                      &languages[Language::Bash]},
    {".ini",                        &languages[Language::Properties]},
    {".properties",                 &languages[Language::Properties]},
    {".cs",                         &languages[Language::CSharp]},
    {".bas",                        &languages[Language::Basic]},
    {".frm",                        &languages[Language::Basic]},
...
{
    {&languages[Language::CPP], {SCLEX_CPP, stylesC, keywordsC, propertiesC}},
    {&languages[Language::Makefile], {SCLEX_MAKEFILE, stylesMake, nullptr, nullptr}},
    ...
    {&languages[Language::JSON], {SCLEX_JSON, stylesJSON, keywordsJSON, propertiesJSON}},
    {&languages[Language::YAML], {SCLEX_YAML, stylesYAML, keywordsYAML, nullptr}},
    {&languages[Language::HTML], {SCLEX_HTML, stylesHTML, keywordsHTML, propertiesHTML}},
    {&languages[Language::Properties], {SCLEX_PROPERTIES, stylesProperties, nullptr, nullptr}},
    {&languages[Language::CSharp], {SCLEX_CPP, stylesC, keywordsCSharp, propertiesC}},
    {&languages[Language::VB], {SCLEX_VB, stylesBasic, keywordsVbNet, nullptr}},
    {&languages[Language::Basic], {SCLEX_VB, stylesBasic, keywordsBasic, nullptr}},
    {&languages[Language::Pascal], {SCLEX_PASCAL, stylesPascal, keywordsPascal, nullptr}},
    {&languages[Language::LaTex], {SCLEX_LATEX, stylesTeX, nullptr, nullptr}},
    {&languages[Language::SQL], {SCLEX_SQL, stylesSQL, keywordsSQL, propertiesSQL}},
};
